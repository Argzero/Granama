var enemyManager = {
    ...
    expData: [
        {value: 25, sprite: images.get('exp25')},
        {value: 10, sprite: images.get('exp10')},
        {value: 5, sprite: images.get('exp5')},
        {value: 3, sprite: images.get('exp3')},
        {value: 1, sprite: images.get('exp1')}
    ];
    ...
    draw: function(camera) {
        ...
        if (game.score >= this.bossScore - 10) {
            ...
            var halfX = game.windowWidth / 2;
            var halfY = game.windowHeight / 2;

 ...
 */
extend('Bomber', 'Enemy');
function Spinner(name, x, y, health, speed, range, exp, rank, patternMin, patternMax, damage, distance, back, spin) {
...
function LightSpinner(x, y) {
    this.super(
        ...
        /* speed       */ 5 + 0.3 * enemyManager.bossCount,
        /* range       */ 0,
        /* exp         */ Enemy.LIGHT_EXP,
    ...
    if (!game.paused) {
        ...
        if (this.fire && this.damage && this.fireCd <= 0) {
            ...
            for (var i = 0; i < 4; i++) {
                ...
                enemyManager.bullets.push(fire);
                fireDir.rotate(0, 1);
                fireVel.rotate(0, 1);

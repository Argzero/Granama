function PlayerTraitorType() {
    ...
    p.laserData = { sprite: GetImage('bossLaser'), cd: 0, range: LASER_RANGE, list: p.bullets, dx: 0, dy: 54, pierce: true };
    p.droneLaser = { sprite: GetImage('bossLaser'), cd: 0, range: LASER_RANGE, list: p.bullets, dx: 65, dy: 54, pierce: true };
